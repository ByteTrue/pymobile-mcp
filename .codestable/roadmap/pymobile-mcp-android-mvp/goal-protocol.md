...
本文件复制到 `.codestable/roadmap/pymobile-mcp-android-mvp/goal-protocol.md` 后，由 `/goal` 会话读取。详细执行规则拆到同目录子文档，避免单个 md 超过 300 行。

## 1. 先读文件

- `.codestable/roadmap/pymobile-mcp-android-mvp/goal-state.yaml`
- `.codestable/roadmap/pymobile-mcp-android-mvp/goal-plan.md`
- `.codestable/roadmap/pymobile-mcp-android-mvp/pymobile-mcp-android-mvp-roadmap.md`
- `.codestable/roadmap/pymobile-mcp-android-mvp/pymobile-mcp-android-mvp-items.yaml`
- `.codestable/roadmap/pymobile-mcp-android-mvp/goal-features/*.md`
- `.codestable/roadmap/pymobile-mcp-android-mvp/goal-protocol-feature-loop.md`
- `.codestable/roadmap/pymobile-mcp-android-mvp/goal-protocol-gates.md`
- `.codestable/roadmap/pymobile-mcp-android-mvp/goal-protocol-audit.md`
...
Plan: .codestable/roadmap/pymobile-mcp-android-mvp/goal-plan.md
Protocol: .codestable/roadmap/pymobile-mcp-android-mvp/goal-protocol.md
```
