...
```bash
python3 .codestable/tools/codestable-goal-consistency-gate.py --roadmap .codestable/roadmap/pymobile-mcp-android-mvp
```
...
写 `.codestable/roadmap/pymobile-mcp-android-mvp/goal-audit.md`：
...
# pymobile-mcp-android-mvp Goal 最终审计
...
同时写 `.codestable/roadmap/pymobile-mcp-android-mvp/goal-evidence-summary.md` 或在 goal-audit 第 7 节等价内嵌：
