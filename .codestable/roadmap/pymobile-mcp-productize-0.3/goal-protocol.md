...
本文件复制到 `.codestable/roadmap/pymobile-mcp-productize-0.3/goal-protocol.md` 后，由 `/goal` 会话读取。详细执行规则拆到同目录子文档，避免单个 md 超过 300 行。
...
- `.codestable/roadmap/pymobile-mcp-productize-0.3/goal-features/*.md`
- `.codestable/roadmap/pymobile-mcp-productize-0.3/goal-protocol-feature-loop.md`
- `.codestable/roadmap/pymobile-mcp-productize-0.3/goal-protocol-gates.md`
- `.codestable/roadmap/pymobile-mcp-productize-0.3/goal-protocol-audit.md`
...
Plan: .codestable/roadmap/pymobile-mcp-productize-0.3/goal-plan.md
Protocol: .codestable/roadmap/pymobile-mcp-productize-0.3/goal-protocol.md
```
