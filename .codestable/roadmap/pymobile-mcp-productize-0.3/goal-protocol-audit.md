...
```bash
python3 <cs-onboard skill 目录>/tools/codestable-goal-consistency-gate.py --roadmap .codestable/roadmap/pymobile-mcp-productize-0.3
```
...
写 `.codestable/roadmap/pymobile-mcp-productize-0.3/goal-audit.md`：
...
# pymobile-mcp-productize-0.3 Goal 最终审计
...
同时写 `.codestable/roadmap/pymobile-mcp-productize-0.3/goal-evidence-summary.md` 或在 goal-audit 第 7 节等价内嵌：
